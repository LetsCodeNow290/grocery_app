...
urlpatterns = [
    ...
    path('food_cat/<int:pk>/delete', DeleteFoodCategory.as_view(), name='food_cat_delete'),
    path('food_cat/<int:pk>/update', UpdateFoodCategory.as_view(), name='food_cat_update'),
    path('food_cat/list', ListFoodCategory.as_view(), name='food_cat_list'),
    path('recipe_book/', AddRecipeBook.as_view(), name='recipe_book'),
    path('recipe_book/<int:pk>/delete', DeleteRecipeBook.as_view(), name='recipe_book_delete'),
    path('recipe_book/<int:pk>/update', UpdateRecipeBook.as_view(), name='recipe_book_update'),
    ...
    path('recipe_cat/<int:pk>/delete', DeleteRecipeCategory.as_view(), name='recipe_cat_delete'),
    path('recipe_cat/<int:pk>/update', UpdateRecipeCategory.as_view(), name='recipe_cat_update'),
    ...
    path('recipe/<int:pk>/add_ingredient', add_ingredient, name='add_ingredients'),
    path('recipe_list/', RecipeFilterList.as_view(), name='recipe_list'),
    path('recipe_list/<int:pk>/delete', RecipeDelete.as_view(), name='recipe_delete'),
    path('recipe_list/<int:pk>/update', RecipeUpdate.as_view(), name='recipe_update'),
    path('recipe_list/<int:pk>', RecipeDetail.as_view(), name='recipe_detail'),
    path('recipe_to_list/<int:pk>/', recipe_to_list, name='recipe_to_list'),
    ...
    path('grocery_detail_and_remove/<int:pk>', grocery_detail_and_remove, name='grocery_detail_and_remove'),
    path('choose_store/', choose_store, name='choose_store'),
    path('store/create_store/', CreateStore.as_view(), name='create_store'),
    path('store/update_store/', UpdateStore.as_view(), name='update_store'),
    path('store/delete_store/', DeleteStore.as_view(), name='delete_store'),
    path('store/food_to_aisle/', store_food_to_aisle, name='food_to_aisle'),
