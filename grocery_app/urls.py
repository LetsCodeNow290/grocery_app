...
urlpatterns = [
    ...
    path('aisle/list', ListAisle.as_view(), name='aisle_list'),
    ...
    path('ingredients/', add_ingredient, name='add_ingredients'),
    ...
    path('add_to_list/<int:pk>/', add_to_list, name='add_to_list'),
