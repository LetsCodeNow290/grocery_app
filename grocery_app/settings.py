...
SECRET_KEY = '36sr2skh#3dkb(w3x_z+i9@#ynxelm%xlvo!a4jjg6wwx*ki0u'
...
INSTALLED_APPS = [
    ...
    'app_components.apps.AppComponentsConfig',
    'app_home.apps.AppHomeConfig',
    'app_groceries.apps.AppGroceriesConfig',
    'app_stores.apps.AppStoresConfig',
    'natsort',
    'django_filters',
    'django.forms',
]
