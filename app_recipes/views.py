...
def start_recipe(request):
    if request.method == "POST":
        ...
        form = RecipeForm()
    return render(request, 'app_recipes/recipe_form.html', {'form': form})
...
def add_ingredient(request, pk):
    ...
    return render(request, 'app_recipes/ingredient_form.html', {'form': form, 'data': data, 'add_food':add_food})
...
def recipe_to_list(request, pk):
    if request.method == 'POST':
        ...
        form = RecipeToList()
    return render(request, 'app_recipes/recipe_to_list_form.html', {'form': form})
